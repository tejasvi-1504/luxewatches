...
export default function Footer() {
  return (
    <footer style={{ background: '#0a0806', borderTop: '1px solid rgba(201,168,76,0.08)' }}>
      ...
      <div className="flex items-center justify-center py-8 px-6">
        <div className="flex items-center gap-6 max-w-xs w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-cormorant text-sm tracking-[0.3em] uppercase" style={{ color: 'rgba(201,168,76,0.45)' }}>LuxeWatches</span>
            <span style={{ color: 'rgba(201,168,76,0.25)', fontSize: 8 }}>✦</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0"
                style={{ border: '1px solid rgba(201,168,76,0.4)', background: 'rgba(201,168,76,0.07)' }}>
                <span className="text-[9px] font-bold" style={{ color: '#C9A84C' }}>LW</span>
              </div>
              <span className="font-cormorant text-xl font-light tracking-[0.18em] uppercase" style={{ color: 'rgba(237,232,223,0.8)' }}>
                Luxe<span className="gold-text font-medium">Watches</span>
              </span>
            </div>
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(237,232,223,0.32)', lineHeight: 1.85 }}>
            ...
            <div className="flex gap-2.5">
              {SocialIcons.map(({ label, path }) => (
                <motion.a key={label} href="#" title={label}
                  ...
                  whileHover={{ borderColor: 'rgba(201,168,76,0.35)', background: 'rgba(201,168,76,0.08)', y: -2 }}>
                  <svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor" style={{ color: 'rgba(237,232,223,0.4)' }}>
                    <path d={path} />
                  </svg>
                </motion.a>
              ))}
          ...
          {/* Shop */}
          <div>
            <h4 className="text-[9px] font-semibold tracking-[0.45em] uppercase mb-6 flex items-center gap-2" style={{ color: '#C9A84C' }}>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-7">
              <li className="flex items-center gap-2.5 text-sm" style={{ color: 'rgba(237,232,223,0.35)' }}>
                <Mail size={12} style={{ color: '#C9A84C', flexShrink: 0 }} />
                support@luxewatches.in
              </li>
              <li className="flex items-center gap-2.5 text-sm" style={{ color: 'rgba(237,232,223,0.35)' }}>
                <Phone size={12} style={{ color: '#C9A84C', flexShrink: 0 }} />
                +91 98765 43210
              </li>
              <li className="flex items-center gap-2.5 text-sm" style={{ color: 'rgba(237,232,223,0.35)' }}>
            ...
            <div className="p-4 rounded-xl" style={{ background: 'rgba(201,168,76,0.04)', border: '1px solid rgba(201,168,76,0.1)' }}>
              <p className="text-[9px] tracking-[0.35em] uppercase mb-3" style={{ color: 'rgba(201,168,76,0.65)' }}>Newsletter</p>
              <div className="flex gap-2">
                <input type="email" placeholder="Your email"
                  className="flex-1 bg-transparent text-xs outline-none pb-1.5 min-w-0"
                  style={{ borderBottom: '1px solid rgba(255,255,255,0.12)', color: '#EDE8DF' }}
                ...
                />
                <button className="text-[#C9A84C] hover:text-[#E8C97A] transition-colors shrink-0">
                  <ArrowRight size={14} />
                </button>
              </div>
            </div>
      ...
      <div className="px-4 sm:px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3"
        ...
        <p className="text-[10px] tracking-wide" style={{ color: 'rgba(237,232,223,0.18)' }}>
          © 2024 LuxeWatches. All rights reserved.
        </p>
        <p className="text-[10px]" style={{ color: 'rgba(237,232,223,0.15)' }}>
